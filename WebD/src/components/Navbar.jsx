...
import ThemeContext from "../Alpaca/context/ThemeContext";
const Navbar = () => {
	...
	return (
		<nav className="w-full flex py-6 items-center navbar">
			...
			<ul className="list-none sm:flex hidden items-center flex-1 ml-6">
				...
				<li className={`font-poppins font-normal cursor-pointer text-[16px]  mr-10 hover:text-blue-500`}>
